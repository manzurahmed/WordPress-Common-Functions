...
### ৯.১২ - মেইন কোয়েরি মডিফাই করা ( ইম্পর্ট্যান্ট )

ধরেন, থিমের এমন একটা রিকোয়ারমেন্ট হল যেখানে ব্লক সেকশনে একটা নির্দিষ্ট ক্যাটাগরীর পোস্টগুলো দেখাব না, কিন্তু, সিঙ্গেল পোস্ট ভিউতে দেখাব, যেমন: রিলেটেড পোস্ট সেকশনে। এমন পরিস্থিতিতে WP_Query কে পরিবর্তন করার প্রয়োজন পড়বে। তখন, functions.php তে "pre_get_posts" হুককে ব্যবহার করতে হবে। এই হুকের WP_Query এর "Post & Page Parameters" সেকশনের "post_not_in" আর্গুমেন্টকে ব্যবহার করতে হবে।

**নোট:**
- এই প্যারামিটারগুলোকে একই সাথে একাধিক সংখ্যায় ব্যবহার করা যাবে না। একটা করে ব্যবহার করতে হবে।
- **pre_get_posts হুকটি একই সাথে Admin এর পোস্ট লিস্টের উপরেও কাজ করে**। তাই, is_home() ফাংশন ব্যবহার করে শুধু ওয়েবসাইটের জন্য কাজ করাতে হয়।
- **অবশ্যই $wpq->is_main_query()** ফাংশনটি ব্যবহার করতে হবে। পোস্ট দেখানোর জন্য ওয়ার্ডপ্রেসের বিল্টইন কুয়েরী এবং কাস্টম কুয়েরী মধ্যে প্রভেদ করতে এই ফাংশন দিয়ে ওয়ার্ডপ্রেসকে বুঝিয়ে দিতে হয়, কোনটি মেইন কুয়েরী আর কোনটি কাস্টম কুয়েরী।
...
function alpha_modify_main_query( $wpq )
{
	...
	{
		$wpq->set( 'post_not_in', array(49) ); // 49 is the post number to exclude
	}
}
add_action( 'pre_get_posts', 'alpha_modify_main_query');
```

**নোট:** $wpq->is_main_query() ব্যবহার করা না হলে, পরবর্তীতে যতগুলো WP_Query ব্যবহার করা কাস্টম কুয়েরী চালানো হবে, সবগুলো কুয়েরীতেই আগের  pre_get_posts হুকের post_not_in আর্গুমেন্টটি কার্যকর হয়ে থাকবে।
